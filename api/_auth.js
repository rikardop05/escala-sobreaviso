 ...
 *
 * Returns { userId, email, memberId, teamId, adminOf, scheduleEditOf, role } on success.
...
export async function requireUser(req) {
  ...
  const { memberId, teamId, adminOf, scheduleEditOf, role } = resolveAccess(email);
  return { userId, email, memberId, teamId, adminOf, scheduleEditOf, role };
}
